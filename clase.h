...
class clase{
	...
	void imprimir();
	listaD<string> obtenerClases(int cedula,string nombre);
...
listaD<string> obtenerClase(int cedula, string nombre){
	//Una vez ordenado el arreglo de cedulas, se puede usar el algoritmo binario para buscar la cedula del profesor
	listaD<string> lista;
